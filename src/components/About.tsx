        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center">
            <div className="relative">
              <div className="w-80 h-80 bg-gradient-to-br from-slate-700 to-slate-600 rounded-2xl flex items-center justify-center professional-shadow">
                <Icon name="User" size={120} className="text-yellow-400" />
              </div>

              {/* Decorative Badge */}
              <div className="absolute -bottom-6 -right-6 w-20 h-20 gold-gradient rounded-xl flex items-center justify-center professional-shadow">
                <Icon name="Scale" size={32} className="text-slate-900" />
              </div>
            </div>
          </div>
